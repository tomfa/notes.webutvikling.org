...
description: "Don't write comments, don't write off the line, don't make complex methods with many parameters, don't do lousy encapsulation, don't make complex methods with many parameters, don't do lousy encapsulation, testing should be a reflection of your functions."
---
