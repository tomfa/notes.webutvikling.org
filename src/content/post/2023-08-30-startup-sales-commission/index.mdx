...
They grabbed the Lead who had waited the longest from a list, and called the potential customer to talk about how a tub may be produced, what materials they had and what was popular these days.
...
GoldTub to be able to deliver anything at all. But now, they finally managed to scramble together some simple metrics on lead to contract convertion rates:

- Number of sales (total and for each sale team member)
- Convertion rate from lead to contract (1%)
- Convertion rate based on zip-code (0.01% - 10%)
- Proportion of sales happening in which phone call (50% happened in the 1st call, 25% in 2nd call... etc).

This revealed something interesting: Han Solo sold more, but Chewbacca had a higher convertion rate.
...
Chewbacca and Han Solo didn't think much of this. Han Solo was happy to be selling well. Chewbacca took pride in high convertion.
...
To ensure sales weren't disappointed, the numbers were set so (given last months sales) wages would increase in total.

By the end of the month, convertion from Lead to Contract increased from 1% to 1.3%. Success!
...
Sales had useed the ability to Abandon as a sales argument to increase convertion: "If you regret it, you can always abandon", was a phrase now commonly heard in the sales office.
...
Sales complained on the intercom that they were often low on Leads lately, and asked marketing to up the spending to increase
...
No, he couldn't find anything. After a while he managed to gather new metrics, indicating conversion from Visit to Lead.
But also this was stable.

He concluded the only thing causing Sales to be low on Leads, must be that they're more efficient than before?
R2-D2 gave his findings to Luke, and asked if he should increase marketing spend. Luke had found something else:
...
R2-D2 couldn't shake this thought out of his head. What had happened?
He dug up the numbers for the last two weeks, who was not yet shown in the metrics, and then it hit him:
...
>
> We have a .97% conversion of 500$, giving each Lead a value of around 5$.
...
>
> We don't want to keep calling Leads
> forever either. There's a point where calling an old lead has less value
...
**So what would you do differently to improve this situation?**
- For bonuses, I would consider company bonus based on how the company as a whole does, if at all. Giving the sales team a shared bonus based on total sales (or conversion rate!) can be a compromise between the two.
...
the reward is substantial and the metric selected is permanent. Make fixing bad metrics a temporary project, or make the reward symbolic.
