...
tags: ["Reid Hoffman", scaling, startup, management]
category: book
---
...
Efficiency in this book is about value per monetary input. One example he mentions would be to pay construction workers to work around the clock, to finish a work-site in 3 months instead of 6, implicitly paying them a lot _more money to do the same thing_. It's not about efficency per employee hour, but efficiency per dollar.
