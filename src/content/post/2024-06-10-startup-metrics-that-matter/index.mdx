...
pubDate: 2024-06-10
description: "Seed-stage metrics that calm investors: revenue, churn, margins. Stickiness first, and only if you actually measure."
...
Stickiness is super important, so measure different churns thoroughly. And keep them ready at hand with investors. Apparently, a common mistake is being caught off guard when investors ask about _yearly_ churn, and you only know _monthly_ (or vice versa).
...
Let's say you have 0 marketing budget. You do _not_ hire a marketing agency to generate some content. You do _not_ spend time or money on a campaign setup. You yourself only spend 10% of your time on sales-related activities, and you do not take any pay as a founder.
...
- = CLTV of 0,4 _ 100 _ 24 = 960$ CLTV
