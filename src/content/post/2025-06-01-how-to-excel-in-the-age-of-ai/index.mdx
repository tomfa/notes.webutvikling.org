---
title: "How to excel in the AI-age"
pubDate: 2025-06-01
...
5. 🟩 **Implementation**: Writing code, or performing configurations. 
   - For more complex implementations, you may have to go back to step 1 (and follow the paranthesis texts)
...
Because AI will get stuff done with mediocre quality, so we need to get good at evaluating these implementations, understand what and why something will or won't work – and give feedback on how it could've been better.

### Implement better QA

It's incredible how large a product becomes after a while. There's so many pages, features and interdependancies.
...
### Use more 3rd party software

[Not-invented-here syndrome](https://en.wikipedia.org/wiki/Not_invented_here) will become a more dangerous disease than ever, for two reasons.
...
AI Antichurn tool [Revatto](https://revatto.com) integrates into Chargebee to automate anti-churn effeort. 
...
harder to relate to people in our proximity and diving societes. Truthfulness has become
...
I think that we with AI can generate content that surpasses the quality of the bottom 70% of current work being done. So we need humans to perform better to let them keep their jobs. Below-averagee performers will be let go.
