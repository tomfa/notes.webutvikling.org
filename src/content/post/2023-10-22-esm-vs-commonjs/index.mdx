...
imageAlt: "An illustration of imports of physical good. Open question: can you tree-shake a cargo ship? "
---
...
I believe a main difference being `esm` modules are imported asynchronously on use, while `commonjs` are imported sync immediately. 
