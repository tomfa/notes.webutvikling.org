...
pubDate: 2021-10-19
heroImage: /images/gbigquery.png
tags: ["big query", python]
...
<Gist client:load id="9492ac855ad0095a5e595822d5aada75" file="requirements.txt" />
...
<Gist client:load id="9492ac855ad0095a5e595822d5aada75" file="bigquery_import.py" />
