...
category: "statement"
description: "Default exports look cleaner on the import line, then break find-usages, rename, and go-to-definition in your own code."
---
...
Even if your IDE decides to rename default imports, you might have imported it as `LadningPage` once.
