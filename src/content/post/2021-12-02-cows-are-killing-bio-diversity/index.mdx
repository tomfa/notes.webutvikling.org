...
pubDate: 2021-12-02
description: "CO2 gets the headlines. Biodiversity dies from land use, and most of that land is for cows."
heroImage: /images/david-clode-tPIOleTRY5A-unsplash.jpg
tags: [climate, off-topic]
category: statement
imageAlt: "Wombats are the cutest animal alive. They poop square, which they use to mark own territory. But humans have flags and bulldozers, which easily win over poop. Photo by @davidclode on Unsplash"
---
...
People can't sit on a song, and Mona Lisa won't help anyone survive in the desert.
...
Around this time (~1800) we were [about 900 million inhabitants](https://en.wikipedia.org/wiki/Estimates_of_historical_world_population#Before_1950).
...
In the same period (1930-2020), world population has quadrupled. Every year since 1980, we've steadily become roughly [80 million extra people, every single year](https://www.worldometers.info/world-population/).
...
If you pull a single carbon atom from a random mammal on earth, how likely is it that it comes from a human? Or from our livestock?
What's the chances that it comes from a whale, dolphin, lion or ice bear? Reindeer or Elk?
...
It's a 60% chance that it's our livestock. All wild mammals combined across the globe amount to 4%.

### Stop claiming land for cows

Without a doubt, wildlife is dying around us. And this part is not due to a warming climate; the [largest cause of animal endangerment]() is reduced amount of accessible land area.

We shouldn't stop talking about CO2. But we must start talking about land and resource usage.

[50% of all habitable land is used for agriculture](https://ourworldindata.org/land-use), of which [60% is used for Beef cattle](https://grazingfacts.com/land-use) alone. So just stop eating cows. Please. For the sake of billions of souls who are unfortunate not to be human.
