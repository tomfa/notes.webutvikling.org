...
like automated Google Hangout link (it's still Corona?). BUT, integrating it with your own website involves [using their widgets or iframes](https://calendly.stoplight.io/docs/embed-api-docs/docs/A-Getting-Started.md)
