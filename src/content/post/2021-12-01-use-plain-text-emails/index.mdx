...
pubDate: 2021-12-01
description: "People say they prefer HTML emails, but they engage more with plain text — it feels like a person, not a billboard."
heroImage: /images/melinda-gimpel-5Ne6mMQtIdo-unsplash.jpg
tags: [email, plain-text, deliverability]
category: statement
...
"Your package is en route" or order receipt emails are split about 50/50 plain text/html.

## Plain text = 1 recipient
...
## Higher opening rates with plain text
...
## Higher click-through rates with plain text
...
- Sales and promotion emails containing more than 1 product can't realistically work in plain text.
...
Off-topic: I read (somewhere) recently about a guy who always sent his emails with the same emoji at the start of the subject line to create recognizability :)
...
Obviously, these sources are biased. Links below seems more trustworthy :)
