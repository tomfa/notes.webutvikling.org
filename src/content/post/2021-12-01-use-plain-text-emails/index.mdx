...
- Sales og promotion emails containing more than 1 product can't realistically work in plain text.
...
Off-topic: I read (somewhere) recently about a guy who alwyas sent his emails with the same emoji at the start of the subject line to create recognizability :)
