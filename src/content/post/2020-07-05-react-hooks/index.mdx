...
## Avoid useContext?
Why do we use useContext? Isn't it just a non-local non-global state? Why do we want to separate it somewhere in the DOM tree? Does it help if we need two different contexts?
